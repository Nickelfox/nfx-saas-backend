...
class CustomUserAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        fieldsets[0][1]["fields"] = [
            field for field in fieldsets[0][1]["fields"] if field not in fields_to_hide
        ]
        ...
        if user.is_super_user:
            ...
            if not del_perm:
                ...
                if (user.role.role_permissions != ss_available_role_permissions) and (
                    obj and obj.role.role_permissions == ss_available_role_permissions
        ...
        if user.is_company_owner:
            ...
            if not del_perm:
                ...
                if (user.role.role_permissions != com_available_role_permissions) and (
                    obj and obj.role.role_permissions == com_available_role_permissions
                ):  # Compare with all available role permissions
                    return False  # Superadmins cannot be deleted
